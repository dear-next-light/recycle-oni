...
export class Camera{
 ...
 get aspect(){return this.width>this.height?0.68:1}
 get base(){return Math.min(this.width/24,this.height/(14*this.aspect))}
 get view(){const scale=this.base*this.zoom;return{scale,scaleY:scale*this.aspect,x:(this.width-24*scale)/2+this.panX,y:(this.height-14*scale*this.aspect)/2+this.panY}}
